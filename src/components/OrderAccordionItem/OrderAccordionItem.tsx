          ...
          <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 className="px-2 text-sm">{order.status}</h1>
              </div>
              ...
              <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200 mb-2">
                <svg
                ...
                <h1 className="px-2 text-sm">${order.total}</h1>
              </div>
              <Link href={`/orders/${order.id}`} className="btn mx-auto mt-8">
                Ver mi pedido
              </Link>
            </div>
          </div>

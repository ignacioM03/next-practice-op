        ...
        <div className="space-y-6 mt-6">
          ...
          >
            ...
            <div className="relative mb-6 flex justify-between">
              <label
                htmlFor="outlet"
                className=" items-center mb-2 text-gray-600 text-sm font-medium"
              >
                Destacar producto{" "}
                <svg
                  width="7"
              ...
              <input
                type="checkbox"
                id="outlet"
                className="block w-full h-5 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none "
                placeholder="Desatacado..."
                {...register("outlet", { required: false })}
              />
            </div>
            <div className="relative mb-6">
              <label

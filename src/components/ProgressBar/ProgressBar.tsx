          ...
          <div className="px-4 py-12 bg-white">
            <div className="mx-auto flex justify-center">
              <div className="relative">
                <div className="w-[160px] h-[160px] border border-teal-400 rounded-full" />
                <div className="w-[140px] h-[140px] border border-teal-400 rounded-full absolute top-2.5 right-2.5" />
                <div>
                  <svg

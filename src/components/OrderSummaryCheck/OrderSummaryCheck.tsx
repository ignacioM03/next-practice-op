          ...
          <div className="relative h-full">
                    ...
                    <div>
                      ...
                      <ul className="text-xs text-white space-y-3 mt-4">
                        <li className="flex flex-wrap gap-4">
                          Precio <span className="ml-auto"></span>
                        </li>
                        <li className="flex flex-wrap gap-4">
                          Cantidad{" "}
                        ...
                        <li className="flex flex-wrap gap-4">
                          Precio <span className="ml-auto">${item.price}</span>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="absolute left-0 bottom-0 bg-[#444] w-full p-4">
              <h4 className="flex flex-wrap gap-4 text-base text-white">
                Total <span className="ml-auto">${order.total}</span>
              </h4>
            </div>
          </div>
        </div>
            ...
            <div className="mt-6">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <input
                  ...
                  placeholder="State"
                  className="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none"
                  value={order.user.address.suite}
                />
                <input
                  type="text"
                  placeholder="Zip Code"
                  className="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none"
                  value={order.user.address.zipcode}
                />
              </div>
